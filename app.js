...
const userQNANotionRouter = require("./routes/user/qna-notion");
const userQNAGPTRouter = require("./routes/user/qna-gpt");
const userMentoringOnlineRouter = require("./routes/user/mentoring-online");
...
app.use("/qna-notion", userQNANotionRouter);
app.use("/qna-gpt", userQNAGPTRouter);
app.use("/mentoring-online", userMentoringOnlineRouter);
